...
from ingredients import (  # type: ignore
    Ingredient, TomatoSauce, Mozzarella, Tomato, Pepperoni, Chicken, Pineapple
)
...
class BasePizza:
    ...
    @property
    def content(self) -> Sequence[Ingredient]:
        """
        Pizza ingredients
    ...
    @content.setter
    def content(self, new_content: Sequence[Ingredient]):
